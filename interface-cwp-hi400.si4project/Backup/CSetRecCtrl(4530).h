...
public:
     ...
     * @return 0：成功，!0：失败.
     */
    InterfaceResCode SetRecCtrlStop(string &sResult,int RecMode, string TaskId, int ChannelID);
	...
	InterfaceResCode PauseRecord(string &sResult,int RecMode, string TaskId, int ChannelID);
	InterfaceResCode ResumeRecord(string &sResult,int RecMode,int ChannelID, string TaskId, string Title);
...
private:
     ...
     * @return true：成功，false：失败.
     */
    bool SetRecStop(int RecMode, string TaskId, int ChannelID, CData &oResult, char *cResult);
	...
	bool PauseRecordInner(int RecMode, string TaskId, int ChannelID, CData &oResult, char *cResult);	
	bool ResumeRecordInner(int RecMode,int ChannelID, string TaskId, string Title, CData &oResult, char *cResult);
